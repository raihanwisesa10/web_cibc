                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="/dashboard/activity">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$act->nama}}" type="text" class="form-control" id="nama" placeholder="Masukkan Nama Pemain" name="nama">
                        </div>
                        <div class="form-group">
                            <label value="{{$act->point}}" for="nama">Point</label>
                            <input type="text" class="form-control" id="point" placeholder="Masukkan Total Point Pemain" name="point">
                        </div>
                        <div class="form-group">
                            <label for="nama">Assist</label>
                            <input value="{{$act->assist}}" type="text" class="form-control" id="assist" placeholder="Masukkan Total Assist Pemain" name="assist">
                        </div>
                        <div class="form-group">
                            <label for="nama">Steal</label>
                            <input value="{{$act->steal}}" type="text" class="form-control" id="steal" placeholder="Masukkan Total Steal Pemain" name="steal">
                        </div>
                        <div class="form-group">
                            <label for="nama">Block</label>
                            <input value="{{$act->block}}" type="text" class="form-control" id="block" placeholder="Masukkan Total Block Pemain" name="block">
                        </div>
                        <div class="form-group">
                            <label for="nama">Rebound</label>
                            <input value="{{$act->rebound}}" type="text" class="form-control" id="rebound" placeholder="Masukkan Total Rebound Pemain" name="rebound">
                        </div>
                        <div class="row">
