        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <a href="{{url('dashboard/activity/create')}}" class="btn btn-success mb-1">Tambah Data Pemain</a>
                    @if (session('status'))
                    ...
                    <table class="table table-hover mt-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$act->rebound}}</td>
                                <td>
                                    <a href="/dashboard/activity/{ $act->id_pemain }/edit" class="badge badge-info">Edit</a>
                                    <!-- <form action="{{ url('/dashboard/activity/{ $act->id_pemain }') }}/delete" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">Delete</button>
                                    </form> -->
                                    <a href="/dashboard/activity/{ $act->id_pemain }/delete" class="badge badge-info">Edit</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
